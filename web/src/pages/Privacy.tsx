  ...
  return (
    <div className="page">
      <div className="container">
        ...
        <p>
          We retain your data for as long as your account is active. You can delete your account through the app's Settings or <a href="/delete-account">request deletion without the app</a>.
        </p>
